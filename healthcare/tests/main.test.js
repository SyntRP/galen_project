...
//       const driver = createDriver("https://www.practo.com/",size);
...
//   (deviceName, size) => {
//     test("Home page on " + deviceName + " device", function () {
//       const driver1 = createDriver(    "https://www.practo.com/coimbatore/doctor/dr-krishnasamy-s-pediatrician?practice_id=1194446&specialization=Fever%20treatment&referrer=doctor_listing&category_name=service&category_id=144555",size);
//       //  checkLayout(driver, "specs/home.gspec", [deviceName]);
//     });
//   }
// );
